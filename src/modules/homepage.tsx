...
export function Homepage(GLOBALS: Globals, upcomingMovies: Movie[], trendingMedia: (Movie | TV)[]) {
    ...
    return (
        <>
            {generateHomepageSection("📅New & Upcoming Movies IS IT WORKING2!?", upcomingMoviesGrid, LoadMoreButton(currentPage, upcomingMoviesTotalPages, loadMoreFunctionUpcoming))}
